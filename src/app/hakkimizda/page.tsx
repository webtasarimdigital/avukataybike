...
import { Scale, ShieldCheck, Users, CheckCircle2, ArrowRight, Phone, MapPin, Clock, Mail, Award } from "lucide-react";
...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-cream">
      ...
      {/* ── HERO ── */}
      <div className="relative w-full min-h-[520px] flex items-end pt-44 pb-0 overflow-hidden bg-cream-dark">
        <div className="absolute right-0 top-0 w-1/2 h-full opacity-[0.06] flex items-center justify-end text-primary">
          <Scale size={400} />
        </div>
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10 -mt-24 pb-32 space-y-16">
        ...
        <div className="bg-white rounded-[48px] shadow-2xl border border-gray-100 overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            {/* Sol – Ofis Görseli */}
            <div className="relative bg-cream-dark p-10 md:p-16 flex items-center justify-center min-h-[520px] overflow-hidden">
              <div className="absolute bottom-0 left-0 w-64 h-64 bg-accent/15 rounded-full -ml-32 -mb-32 blur-3xl" />
              <div className="relative z-10 flex flex-col items-center gap-6">
                <div className="w-72 h-72 rounded-[40px] bg-cream border border-primary/10 p-1 overflow-hidden shadow-xl">
                  <img src="/Aybike-sultan-bicer.jpeg" alt="Av. Aybike Sultan Biçer" className="w-full h-full object-cover rounded-[36px]" />
                </div>
                <div className="text-center">
                  <p className="text-primary font-black text-2xl italic uppercase">Av. Aybike Sultan Biçer</p>
                  <p className="text-accent text-xs font-bold tracking-[0.3em] uppercase mt-1">Kurucu Avukat</p>
                  <div className="mt-3 space-y-1">
                    <p className="text-primary-muted text-[11px] font-medium">Marmara Üniversitesi Hukuk Fakültesi (2021)</p>
                    <p className="text-primary-muted text-[11px] font-medium">İstanbul Barosu (2021)</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div id="vizyon" className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Vizyon */}
          <div className="relative bg-cream-dark rounded-[40px] p-12 overflow-hidden flex flex-col gap-6 border border-primary/10">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-3xl font-black text-primary uppercase italic mt-2 mb-5">Vizyonumuz</h3>
              <div className="w-12 h-1.5 bg-accent rounded-full mb-6" />
              <p className="text-primary-muted text-base leading-relaxed">
          ...
          {/* Misyon */}
          <div id="misyon" className="relative bg-white rounded-[40px] p-12 border border-primary/10 shadow-sm overflow-hidden flex flex-col gap-6">
        ...
        {/* ── KURUCU AVUKAT ── */}
        <div id="ekibimiz" className="bg-white rounded-[40px] border border-primary/10 shadow-sm overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-[360px_1fr]">
            <div className="bg-cream-dark p-10 flex flex-col items-center justify-center gap-5 relative overflow-hidden">
              <div className="relative z-10 w-56 h-56 rounded-[28px] bg-cream border border-primary/10 p-1 overflow-hidden shadow-md">
                <img src="/Aybike-sultan-bicer.jpeg" alt="Av. Aybike Sultan Biçer" className="w-full h-full object-cover rounded-[24px]" />
              </div>
              <div className="relative z-10 text-center">
                <p className="text-primary font-black text-lg italic uppercase leading-tight">Av. Aybike Sultan Biçer</p>
              ...
              <div className="relative z-10 flex flex-col gap-2 w-full mt-2">
                <div className="bg-cream rounded-xl px-4 py-2 text-center border border-primary/10">
                  <p className="text-primary-muted text-[10px] uppercase tracking-widest font-bold">Baro</p>
                  <p className="text-primary text-xs font-black mt-0.5">İstanbul Barosu</p>
                </div>
                <div className="bg-cream rounded-xl px-4 py-2 text-center border border-primary/10">
                  <p className="text-primary-muted text-[10px] uppercase tracking-widest font-bold">Mezuniyet</p>
                  <p className="text-primary text-xs font-black mt-0.5">Marmara Üniversitesi</p>
                </div>
              </div>
            </div>
            <div className="p-10 md:p-14 flex flex-col justify-center">
              <div className="space-y-3 mb-8">
                <h3 className="text-2xl md:text-3xl font-black text-primary leading-tight uppercase italic">Av. Aybike Sultan <span className="text-accent">Biçer</span></h3>
                <div className="w-12 h-1.5 bg-accent rounded-full" />
              </div>
              <p className="text-primary-muted text-base leading-relaxed mb-6">
              ...
              <p className="text-primary-muted/80 text-base leading-relaxed mb-8">
        ...
        <div className="bg-white rounded-[40px] border border-primary/10 shadow-sm overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-[360px_1fr]">
            <div className="bg-cream-dark p-10 flex flex-col items-center justify-center gap-5 relative overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                <p className="text-primary font-black text-lg italic uppercase leading-tight">Av. Ayşe Nur Şimşek Kırkıncı</p>
            ...
            <div className="p-10 md:p-14 flex flex-col justify-center">
              <div className="space-y-3 mb-8">
                <h3 className="text-2xl md:text-3xl font-black text-primary leading-tight uppercase italic">Av. Ayşe Nur Şimşek <span className="text-accent">Kırkıncı</span></h3>
                <div className="w-12 h-1.5 bg-accent rounded-full" />
              </div>
              <p className="text-primary-muted text-base leading-relaxed mb-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              { icon: <CheckCircle2 size={44} />, t: "Güncel Hukuki Bilgi", d: "Değişen mevzuat ve yargıtay kararlarını anlık takip ederek müvekkillerimize her zaman en güncel ve doğru hukuki danışmanlığı sunuyoruz." },
            ].map((item, i) => (
              <div key={i} className="bg-white p-10 rounded-[32px] shadow-sm border border-primary/10 flex flex-col group hover:shadow-xl hover:border-accent/40 transition-all duration-300">
                ...
                <p className="text-primary-muted text-sm leading-relaxed">{item.d}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* ── HİZMETLER GRID ── */}
        <div className="bg-cream-dark rounded-[48px] p-12 md:p-16 relative overflow-hidden border border-primary/10">
          ...
          <div className="relative z-10">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-12">
              <div className="space-y-3">
                ...
                <h2 className="text-3xl md:text-5xl font-black text-primary uppercase italic leading-tight">Çalışma Alanlarımız</h2>
              </div>
              <Link href="/#hizmetler" className="text-primary/60 hover:text-accent transition-colors text-xs font-bold tracking-widest uppercase flex items-center gap-2">
                Tümünü Gör <ArrowRight size={16} />
              </Link>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
              {services.map((s, i) => (
                <Link key={i} href={`/hizmetler/${s.slug}`} className="group bg-cream hover:bg-accent border border-primary/10 hover:border-accent p-5 rounded-2xl transition-all flex items-center justify-between gap-2">
                  <span className="font-bold text-primary group-hover:text-primary text-xs uppercase tracking-wider leading-tight">{s.title}</span>
        ...
        {/* ── YASAL BİLGİLENDİRME ── */}
        <div className="bg-white rounded-[40px] border border-primary/10 p-10 md:p-14">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Ofis Bilgileri */}
          <div className="bg-white rounded-[40px] border border-primary/10 shadow-sm p-10 md:p-14 space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-primary-muted text-sm leading-relaxed">Eğitim Mah., Poyraz Sokak, No:26/4,<br />Kadıköy / İstanbul</p>
                </div>
              </div>
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <a href="tel:05514882948" className="text-primary-muted text-sm hover:text-accent transition-colors font-medium">0551 488 29 48</a>
                </div>
              </div>
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <a href="mailto:info@asblawoffice.com" className="text-primary-muted text-sm hover:text-accent transition-colors font-medium">info@asblawoffice.com</a>
                </div>
              </div>
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-primary-muted text-sm font-medium">Pazartesi – Cuma: 09:00 – 18:00</p>
                  <p className="text-primary-muted/70 text-xs mt-1">Cumartesi randevuyla</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* CTA */}
          <div className="bg-cream-dark rounded-[40px] p-10 md:p-14 relative overflow-hidden flex flex-col justify-between border border-primary/10">
            ...
            <div className="relative z-10 space-y-4 mb-10">
              ...
              <h3 className="text-3xl md:text-4xl font-black text-primary uppercase italic leading-tight">
                Hukuki Sorununuz<br /><span className="text-accent">Çözümsüz Değil.</span>
              </h3>
              <p className="text-primary-muted leading-relaxed">Hukuki süreçlerinizde doğru stratejiyi birlikte belirleyelim.</p>
            </div>
            <div className="relative z-10 flex flex-col gap-4">
              <Link href="/iletisim" className="bg-accent hover:bg-primary hover:text-cream text-primary px-8 py-5 rounded-2xl font-black tracking-widest text-sm transition-all flex items-center justify-center gap-3 shadow-xl shadow-accent/20 uppercase">
                İletişim
              </Link>
            </div>
          </div>
