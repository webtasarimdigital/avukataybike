          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="relative bg-primary p-10 md:p-16 flex items-center justify-center min-h-[420px] overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col items-center gap-6">
                <div className="w-80 h-80 rounded-[40px] bg-white/10 border border-white/20 p-1 backdrop-blur-sm overflow-hidden">
