  ...
  return (
    <main className="min-h-screen bg-[#F6F3ED]">
      ...
      <div className="container mx-auto px-6 max-w-5xl py-20 space-y-12">
        ...
        {/* Ana misyon metni */}
        <div className="bg-primary rounded-[40px] p-12 md:p-16 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-2xl md:text-3xl font-black text-white leading-relaxed italic mb-6">
