...
export const serviceContent: Record<string, ServiceItem> = {
  "banka-ve-ticaret-hukuku": {
    ...
    features: [
      ...
      "Banka kredisi ve finansman uyuşmazlıkları",
      "Kambiyo senetleri ve icra takibi",
      "Ortaklık anlaşmazlıkları ve tasfiye işlemleri",
      "Ticari davaların takibi ve temsil",
    ...
    faq: [
      ...
      { q: "Şirket kuruluşu için avukat gerekli midir?", a: "Zorunlu olmamakla birlikte, esas sözleşmenin doğru hazırlanması ve ortaklık yapısının güvenli kurulması için hukuki destek almanız önerilir." },
      { q: "Banka ile uyuşmazlığımda ne yapmalıyım?", a: "Öncelikle tüm yazışma ve belgeleri saklayın. Hukuki danışmanlık alarak tüketici hakem heyeti veya mahkeme yollarını değerlendirmenizi tavsiye ederiz." },
    ],
    stats: [
      { label: "Çözüme Kavuşturulan Dosya", value: "200+" },
      { label: "Kurumsal Müvekkil", value: "50+" },
      { label: "Ortalama Sonuç Süresi", value: "3 Ay" },
    ],
  },
  ...
  "is-hukuku": {
    ...
    features: [
      ...
      "İş kazası tazminat talepleri",
      "İşçi sağlığı ve iş güvenliği uyuşmazlıkları",
      "Toplu iş sözleşmesi müzakereleri",
      "İşyeri iç yönetmelikleri ve sözleşme hazırlama",
    ],
    process: [
    ...
    faq: [
      ...
      { q: "Mobbing davası açabilir miyim?", a: "İşyerinde sistematik psikolojik baskı ve tacize maruz kaldıysanız, tanık beyanları ve yazışmalar gibi delillerle manevi tazminat davası açabilirsiniz." },
    ],
    stats: [
      { label: "İşçi Davası Kazanma Oranı", value: "%87" },
      { label: "Takip Edilen Dava", value: "150+" },
      { label: "Ortalama Tazminat Tahsil", value: "₺45K" },
    ],
  },
